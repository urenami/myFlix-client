...
export const MovieView = ({ movies }) => {
  ...
  const addFavoriteMovie = (event) => {
    ...
    fetch(`https://my-flixdb-56034.herokuapp.com/users/${user.Username}/movies/${movie._id}`, {
      method: "POST",
  ...
  const toggleMovie = () => {
    ...
    favoriteMoviesValues.some(favM => favM === movie._id) ? setIsFavorite(true) : setIsFavorite(false);
  }
  ...
  return (
    <Card>
      <Card.Img className ="h-50" src={movie.imageUrl} alt="the movie poster" />
      <Card.Body>
